...
class Vectorizer:
    ...
    def _vectorize(self, text: str, config: VectorInputConfig):
        with torch.no_grad():
            if self.shall_split_in_sentences:
                ...
                batch_sum_vectors = 0
                # Performer transformer tokenization and embedding in batches of sentences
                ...
                # create embeddings without splitting text into sentences
                # this will truncate texts that are too long for the model
